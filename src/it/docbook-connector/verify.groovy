...
assert new File( basedir, 'target/docbkx/pdf/OpenICF-1.5.2.0-Docbook-Connector-1.5.2.0.pdf' ).exists();
content = new File( basedir, 'target/docbkx/bootstrap/docbook-connector-1.5.2.0/index.html' ).text;
